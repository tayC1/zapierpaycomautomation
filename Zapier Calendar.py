...
last_day_date = calendar.datetime(today.year, today.month, last_day)
...
fifteenth = datetime(today.year, today.momth, 15)
...
if fifteenth_weekday >=5:
    ...
    ifteenth_weekday = fifteenth

#check if period matches either 
is_last_day_of_period = today.date()==last_workday.date() or today.date() == fifteenth.workday.date()
